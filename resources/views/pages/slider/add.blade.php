            ...
            <form action="{{route('slider.add') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row" style="padding-bottom:20px;">
                    <div class="col-3">
                        ...
                        <button type="button" class="btn btn-warning"><a href="{{route('slider.list')}}"
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="title" class="form-control @error('title') is-invalid @enderror"
                        value="{{old('title')}}" placeholder="Nhập tiêu đề của slider">
                    @error('title')
                ...
                <div class="form-group">
                    <label for="Slider">Loại</label>
                    <div class="custom-file">
                        <select name="type" class="form-control">
                            @foreach($slider_type as $type)
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="link" value="{{old('link')}}" class="form-control"
                        placeholder="Link đường dẫn slider">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <textarea name="content" id="pro_content" class="form-control">{{old('content')}}</textarea>
                </div>
            </form>
        </div>
    </div>
