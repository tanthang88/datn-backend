                        ...
                        <div class="tab-content">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="row pd-10">
                                            ...
                                            <input type="text" name="product_name" class="col-8 form-control @error('product_name') is-invalid @enderror" id="product_name" value="{{ old('product_name')}}" placeholder="Tên sản phẩm">
                                            @error('product_name')
                                        ...
                                        <div class="row pd-10">
                                            ...
                                            <select class="col-8 form-control select2 @error('supplier_id') is-invalid @enderror" id="supplier_id" name="supplier_id" style="width: 80%;" tabindex="-1" aria-hidden="true">
                                        ...
                                        <div class="row pd-10">
                                            ...
                                            <input type="number" class="col-8 form-control @error('product_quantity') is-invalid @enderror" id="product_quantity" name="product_quantity" value="{{ old('product_quantity')}}" placeholder="Số lượng nhập về">
                                    ...
                                    <div class="col-6" style="padding:0 50px;">
                                        <div class="row pd-10">
                                            ...
                                            <select class="col-8 form-control select2 @error('product_quantity') is-invalid @enderror" id="category_id" name="category_id" style="width: 80%;" tabindex="-1" aria-hidden="true">
                            ...
                            <div class="tab-pane" id="content">
                                <div class="row pd-10">
                                    ...
                                    <textarea class="col-12 form-control" name="description" rows="3" placeholder="Bạn bắt buộc phải nhập phần mô tả để SEO tốt hơn"></textarea>
                ...
                <div class="card" style="border-top:1px solid rgba(0,0,0,.125);">
                    ...
                    <div class="card-body" style="padding:0;">
                        <div class="row normalPro">
                                ...
                                <div class="tab-content" id="vert-tabs-tabContent">
                                    <div class="tab-pane text-left fade show active" id="vert-tabs-general" role="tabpanel" aria-labelledby="vert-tabs-general-tab">
                                        <div class="row pd-10">
                                            ...
                                            <input type="number" hidden class="tientehidden" id="product_price" name="product_price" value="{{ old('product_price')}}">
                                            <input type="text" class="col-7 tiente mucgiam form-control"  placeholder="VND" value="{{ old('product_price')}}">
                                        </div>
                                    </div>
                            ...
                            <small class="error-form col-9" style="color: red;font-style: italic"> {{ $message }}</small>
                            @enderror
