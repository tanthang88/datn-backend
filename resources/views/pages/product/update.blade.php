        ...
        <div class="card-body">
                        ...
                        <div class="tab-content">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="row pd-10">
                                            ...
                                            <input type="text" name="product_name" class="col-8 form-control @error('product_name') is-invalid @enderror" id="product_name" value="{{ $data->product_name}}" placeholder="Tên sản phẩm">
                                            @error('product_name')
                                            <span class="col-4"></span>
                                            <small class="error-form col-8" style="color: red;font-style: italic"> {{ $message }}</small>
                                            @enderror
                                        </div>
                                        <div class="row pd-10">
                                            <label class="col-4" for="supplier_id">Nhà cung cấp</label>
                                            <select class="col-8 form-control select2 @error('supplier_id') is-invalid @enderror" name="supplier_id" style="width: 80%;" data-select2-id="1" tabindex="-1" aria-hidden="true">
                                                <option selected="selected" data-select2-id="1" disabled>Nhà cung cấp</option>
                                        ...
                                        <div class="row pd-10">
                                            ...
                                            <input type="number" name="product_quantity" class="col-8 form-control @error('product_quantity') is-invalid @enderror" id="product_quantity" value="{{$data->product_quantity}}" placeholder="Số lượng nhập về">
                                    ...
                                    <div class="col-6" style="padding:0 50px;">
                                        <div class="row pd-10">
                                            ...
                                            <select class="col-8 form-control select2" name="category_id" style="width: 80%;" data-select2-id="1" tabindex="-1" aria-hidden="true">
                                                <option selected="selected" data-select2-id="1" disabled>Chọn danh mục</option>
                                        ...
                                        <div class="form-group pd-row-2">
                                            ...
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" id="img_product" name="img_product"  onchange="ImagesFileAsURL()">
                                        ...
                                        <div class="form-group pd-row-2">
                                            ...
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" id="img_list" name="img_list[]"  onchange="ImagesListFileAsURL()" multiple>
                            ...
                            <div class="tab-pane" id="content">
                                <div class="row pd-10">
                                    ...
                                    <textarea class="col-12 form-control" name="product_desc" rows="3" placeholder="Bạn bắt buộc phải nhập phần mô tả để SEO tốt hơn">{{$data->product_desc}}</textarea>
                                    <p class="col-12" style="padding-left:0;padding-top:10px;font-weight:bold">(Tốt nhất là 250 - 300 ký tự) <strong style="color:red;">- Chú ý: Bạn phải nhập phần mô tả để có kết quả SEO tốt nhất trên Google</strong></p>
                                </div>
                    ...
                    <ul class="nav nav-pills">
                        ...
                        <li class="nav-content">
                            <select class="form-control is_variation" name="is_variation" id="is_variation" onchange="chooseProduct();" style="width:100%;">
                                ...
                                <option value="0"><a class="nav-link active" href="#infomation" data-toggle="tab" selected="selected">Sản phẩm đơn giản</a></option>
                                <option value="1"><a class="nav-link" href="#content" data-toggle="tab">Sản phẩm biến thể</a></option>
                                @else
                                <option value="1"><a class="nav-link" href="#content" data-toggle="tab" selected="selected">Sản phẩm biến thể</a></option>
                                    ...
                                    <div class="tab-content" id="vert-tabs-tabContent">
                                        <div class="tab-pane text-left fade show active" id="vert-tabs-general" role="tabpanel" aria-labelledby="vert-tabs-general-tab">
                                            <div class="row pd-10">
                                                ...
                                                <input type="number" hidden class="tientehidden" id="product_price" name="product_price" value="{{($data->product_price)}}">
                                                <input type="text" class="col-7 tiente mucgiam form-control"  placeholder="VND" value="{{($data->product_price)}}">
                                            </div>
                                        </div>
                                ...
                                <div class="col-7 col-sm-9" style="padding:0.75rem;">
                                    <div class="tab-content" id="vert-tabs-tabContent">
                                        <div class="tab-pane text-left fade show active" id="vert-tabs-properties" role="tabpanel" aria-labelledby="vert-tabs-properties-tab">
                                            <div style="padding-bottom:10px;"><a class="btn btn-primary" style="color:#2271b1;border-color: #2271b1;background: #f6f7f7;" onclick="typeProperties()">Thêm thuộc tính cho sản phẩm </a></div>
                                    ...
                                    <div class="tab-content" id="vert-tabs-tabContent">
                                        <div class="tab-pane text-left fade show active" id="vert-tabs-properties" role="tabpanel" aria-labelledby="vert-tabs-properties-tab">
                                                ...
                                                <div class="card bg-gradient-last collapsed-card" style="color:#555;border-left-color: #6BB5D8;border-left-width: 4px;background-color:#f6f7f7;">
                                                    ...
                                                    <div class="card-body" style="display:none;border-top-width:3px;border-top-style:solid;border-top-color:#EAECF0;">
                                                        ...
                                                        <div class="row pd-10">
                                                            ...
                                                            <input type="text" name="propertie_name[]" value="{{$propertie->propertie_name}}" class="col-7 form-control" id="" placeholder="Tên thuộc tính">
                                                        </div>
                                                        <div class="row pd-10"><label class="col-3">Giá trị(s):</label><textarea class="col-7 form-control" name="propertie_value[]" rows="3" placeholder="Nhập nội dung hoặc một số thuộc tính bằng '|' các giá trị riêng.">{{$propertie->propertie_value}}</textarea></div>
                                                    </div>
                                                </div>
                                                @endforeach
                                            </div>
                                            ...
                                            <div id="new-properties">
                                                <input type="hidden" id="input-propertie" name="input_propertie">
            ...
            <div class="card bg-gradient-new" id="add-properties" style="display:none;color:#555;border-left-color: #28a745;border-left-width: 4px;background-color:#f6f7f7">
                ...
                <div class="card-body" style="border-top-width:3px;border-top-style:solid;border-top-color:#EAECF0;">
                    ...
                    <div class="row pd-10"><label class="col-3">Giá trị(s):</label><textarea class="col-7 form-control" name="propertie_value_n[]" rows="3" placeholder="Nhập nội dung hoặc một số thuộc tính bằng '|' các giá trị riêng."></textarea></div>
                </div>
            </div>
        </div>
    </div>
