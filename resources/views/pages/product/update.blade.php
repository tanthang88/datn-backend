                            ...
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <div class="row pd-10">
                                        ...
                                        <select class="col-8 form-control select2" name="supplier_id" style="width: 80%;" data-select2-id="1" tabindex="-1" aria-hidden="true">
                                ...
                                <div class="tab-content" id="vert-tabs-tabContent">
                                    <div class="tab-pane text-left fade show active" id="vert-tabs-general" role="tabpanel" aria-labelledby="vert-tabs-general-tab">
                                        <div class="row pd-10">
                                            ...
                                            <input type="number" name="product_price" class="col-7 form-control" id="" value="{{ $data->product_price}}" placeholder="Giá" required>
                                            @error('product_price')
                                            <span class="col-4"></span>
                                            <span class="col-8 help-block">{{$message}}</span>
                                            @enderror
