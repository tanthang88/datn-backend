              ...
              <form action="" method="post" class="col-12" enctype="multipart/form-data">
                    <div class="row" style="padding-bottom:20px;">
                        <div class="col-3">
                            ...
                            <button type="button" class="btn btn-warning"><a href="{{route('about.list')}}" style="color:black"><i class="fa fa-exclamation-triangle" aria-hidden="true"></i> Thoát</a></button>
                        </div>
                    </div>
                            ...
                            <div class="tab-content">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="row pd-10">
                                                ...
                                                <input type="text" name="about_name" class="col-10 form-control" id="about_name" value="{{ $about->about_name}}" placeholder="Tên thông tin">
                                                @error('about_name')
                                            ...
                                            <div class="row pd-10">
                                                ...
                                                <input type="text" name="type" class="col-10 form-control" id="" value="{{$about->type}}" placeholder="loại">
                                                @error('type')
                                                    <span class="col-2"></span>
                                                    <span class="col-10 help-block">{{$message}}</span>
                                                @enderror
                                            ...
                                            <div class="row pd-10">
                                                ...
                                                <input type="number" name="about_order" class="col-10 form-control" id="" value="{{ $about->about_order}}" placeholder="Thứ tự">
                                                @error('about_order')
                                                    <span class="col-2"></span>
                                                    <span class="col-10 help-block">{{$message}}</span>
                                                @enderror
                                ...
                                <div class="tab-pane" id="content">
                                    <div class="row pd-10">
                                        ...
                                        <textarea class="col-10 form-control" name="about_desc" rows="3" placeholder="Bạn bắt buộc phải nhập phần mô tả để SEO tốt hơn">{{$about->about_desc}}</textarea>
                                        <p class="col-2"></p>
                                    ...
                                    <div class="form-group pd-10" style="margin-left:-7.5px; margin-right:-7.5px;">
                                        ...
                                        <textarea class="col-10 form-control" name="about_content" id="pro_content" rows="3">{{$about->about_content}}</textarea>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="tab-content">
                                <div class="row pd-10">
                                    ...
                                    <div class="input-group mb-3 col-10">
                                        <input type="text" class="form-control" value="{{ $about->seo_title}}" id="seo_title"  name="seo_title" placeholder="Nội dung thẻ meta Title dùng để SEO" aria-describedby="basic-addon1">
                                ...
                                <div class="row pd-10">
                                    <label class="col-2">Description</label>
                                        <div class="input-group mb-3 col-10">
                                            <input type="text" class="form-control" value="{{ $about->seo_description}}"  name="seo_description" placeholder="Từ khóa chính cho bài viết" aria-describedby="basic-addon1">
                                        </div>
                                </div>
                                <div class="row pd-10">
                                    <label class="col-2">Từ khóa</label>
                                        <div class="input-group mb-3 col-10">
                                            <input type="text" class="form-control" value="{{ $about->seo_keywords}}"  name="seo_keywords" placeholder="Nội dung thẻ meta Description dùng để SEO" aria-describedby="basic-addon1">
...
<script>
    // function Slug(){
    //     $name = $('#about_name').val();
    //     $rename = $name.normalize('NFD').replace(/[\u0300-\u036f]/g, '').replace(/đ/g, 'd').replace(/Đ/g, 'D');
    //     $objectname = $rename.split(" ", 2);
    //     $strname = stringify($objectname);
    //     alert(typeof($strname));
    //     $slug = $strname.replace(/,/g, '-') ;
    //     alert($slug);
    //     $('#seo_title').val($slug);
    // }
</script>
