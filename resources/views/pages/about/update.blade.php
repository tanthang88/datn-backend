        ...
        <div class="container-fluid">
            <div class="card card-primary row">
                <div class="card-header">
                    ...
                    @if($about->updated_at!='')
                        <h3 class="card-title" style="float:right;">Cập nhật vào: {{$about->updated_at}}</h3>
                    @elseif ($about->created_at!='')
                        <h3 class="card-title" style="float:right;">Thêm mới vào: {{$about->created_at}}</h3>
                    @else
                    @endif
                </div>
                <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="row pd-10">
                                                        ...
                                                        <input type="text" name="about_name" class="col-10 form-control @error('about_name') is-invalid @enderror" id="about_name" value="{{ $about->about_name}}" placeholder="Tên thông tin">
                                                        @error('about_name')
                                                    ...
                                                    <div class="row pd-10">
                                                        ...
                                                        <input type="text" name="type" class="col-10 form-control @error('type') is-invalid @enderror" id="type" value="{{$about->type}}" placeholder="loại">
                                                        @error('type')
                                                            <span class="col-2"></span>
                                                            <small class="error-form col-10" style="color: red;font-style: italic"> {{ $message }}</small>
                                                        @enderror
                                                    ...
                                                    <div class="row pd-10">
                                                        ...
                                                        <input type="checkbox" name="about_display" {{$about->about_display==1 ? 'checked' : ''}}>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
