            ...
            <form action="{{route('post.update',['id' => $posts->id])}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row" style="padding-bottom:20px;">
                    <div class="col-3">
                        ...
                        <button type="button" class="btn btn-warning"><a href="{{route('post.list')}}"
                ...
                <div class="row">
                    <div class="form-group col-6">
                        ...
                        <input type="text" name="post_name" id="post_name"
                            class="form-control @error('post_name') is-invalid @enderror" value="{{$posts->post_name}}">
                        @error('post_name')
                    ...
                    <div class="form-group col-6">
                        ...
                        <select name="category_id" id="category_id"
                            ...
                            <option {{($post_categorie->id== $category_id) ?' selected' : ''}}
                                value="{{$post_categorie->id}}">{{$post_categorie->category_name}}</option>
                            @endforeach
                        </select>
                        @error('category_id')
                        <small class="error-form" style="color: red;font-style: italic"> {{ $message }}</small>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="post_seo_description" class="form-control"
                        value="{{$posts->post_seo_description}}"
