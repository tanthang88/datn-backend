        ...
        <div class="card-body">
            <form action="{{route('post.store')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row" style="padding-bottom:20px;">
                    <div class="col-3">
                        ...
                        <button type="button" class="btn btn-warning">
                            <a href="{{route('post.list')}}" style="color:black"><i class="fa fa-angle-double-left"
                                    aria-hidden="true"></i>
                                Thoát</a>
                        </button>
                    </div>
                ...
                <div class="row">
                    <div class="form-group col-6">
                        ...
                        <input type="text" name="post_name" id="post_name"
                            class="form-control @error('post_name') is-invalid @enderror" value="{{old('post_name')}}"
                    ...
                    <div class="form-group col-6">
                        ...
                        <select name="category_id" id="category_id"
                            ...
                            <option value="{{ $post_categories->id }} {{ old('category_id') == $post_categories->id ? "
                                selected" : "" }}">{{ $post_categories->category_name }}</option>
                            @endforeach
                        </select>
                        @error('category_id')
                        <small class="error-form" style="color: red;font-style: italic"> {{ $message }}</small>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="post_seo_title" class="form-control" value="{{old('post_seo_title')}}"
                        placeholder="Nội dung thẻ Meta Title dùng để SEO">
                </div>
                <div class="form-group">
                    <label>SEO Keyword</label>
                    <input type="text" name="post_seo_keyword" class="form-control" value="{{old('post_seo_keyword')}}"
                        placeholder="Từ khóa chính cho bài viết">
                </div>
                <div class="form-group">
                    <label>SEO Description</label>
                    <input type="text" name="post_seo_description" class="form-control"
                        value="{{old('post_seo_description')}}"
                        placeholder="Nội dung thẻ meta Description dùng để SEO ">
                </div>
            </form>
        </div>
    </div><!-- /.container-fluid -->
