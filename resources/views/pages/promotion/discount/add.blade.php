...
@section('title')
Tạo chương trình giảm giá sản phẩm mới
@endsection
@push('style')
@endpush
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-primary">
                ...
                <form method="POST" action="{{route('promotion.discount.store')}}" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('discout_name') is-invalid @enderror" id="discout_name" name="discout_name" placeholder="Nhập tên chương trình" value="{{ old('discout_name') }}">
                                    @error('discout_name')
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control float-right @error('discout_daterange') is-invalid @enderror reservationtime" id="discout_daterange" name="discout_daterange" value="{{ old('discout_daterange') }}">
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" hidden class="tientehidden" id="discout_rate" name="discout_rate" value="{{ old('discout_rate') }}">
                                    <input type="text" class="tiente mucgiam form-control @error('discout_rate') is-invalid @enderror" placeholder="% or VND" value="{{ old('discout_rate') }}">
                                    @error('discout_rate')
                                    <small class="error-form" style="color: red;font-style: italic"> {{ $message }}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('discout_numberofuse') is-invalid @enderror" id="discout_numberofuse" name="discout_numberofuse" placeholder="Nhập số giới hạn đặt hàng" value="{{ old('discout_numberofuse') }}">
                            ...
                            <div class="col-md-12">
                                <div class="row g-3 align-items-center box-form-giam-gia add-them-san-pham">
                                    @php if (Session::get('dataSessionProductDiscount') != null) { @endphp
                                    <div class="col-6">
                                        <label for="" class="col-form-label pr-4">Sản phẩm</label>
                                        <small class="text-secondary"><span class="text-danger">{{count(Session::get('dataSessionProductDiscount'))}} </span>&nbsp;sản phẩm tham gia chương trình giảm giá này</small>
                                    </div>
                        ...
                        @php
                        if (Session::get('dataSessionProductDiscount') != null) { @endphp
...
@endpush
@prepend('scripts')
<script type="module" src="{{Vite::asset('resources/js/discount/add.js')}}"></script>
@endprepend
