    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-primary">
                ...
                <form method="POST" action="{{route('promotion.dealsock.store')}}" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('dealsock_name') is-invalid @enderror" id="dealsock_name" name="dealsock_name" placeholder="Nhập tên chương trình" value="{{ old('dealsock_name') }}">
                                    @error('dealsock_name')
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control float-right @error('dealsock_daterange') is-invalid @enderror reservationtime" id="dealsock_daterange" name="dealsock_daterange" value="{{ old('dealsock_daterange') }}">
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('dealsock_numberofuse') is-invalid @enderror" id="dealsock_numberofuse" name="dealsock_numberofuse" placeholder="Nhập số giới hạn đặt hàng" value="{{ old('dealsock_numberofuse') }}">
                                ...
                                <div class="row g-3 align-items-center box-form-giam-gia add-them-san-pham">
                                    <div class="col-12">
                                        <div class="row">
                                            ...
                                            @if(Session::get('dataSessionProductDealsock') == null)
                                            <div class="col-3">
                                                <div class="btn btn-outline-danger btn-sm" data-toggle="modal" data-target="#modal-dealsockProduct"><i class="fas fa-plus"></i> Thêm sản phẩm</div>
                                            </div>
                                            @else
                                            <div class="col-3">
                                        ...
                                        @php
                                        if (Session::get('dataSessionProductDealsock') != null) { @endphp
                                    ...
                                    <div class="col-12 my-3">
                                        <div class="row">
                                            ...
                                            @if(Session::get('dataSessionProductDealsockCombo') == null)
                                            <div class="col-3">
                                                <div class="btn btn-outline-danger btn-sm" data-toggle="modal" data-target="#modal-dealsockProductCombo"><i class="fas fa-plus"></i> Thêm sản phẩm</div>
                                            </div>
                                            @else
                                            <div class="col-3">
                                        ...
                                        @php
                                        if (Session::get('dataSessionProductDealsockCombo') != null) { @endphp
                                        <div class="my-2 box-form-giam-gia">
...
@endpush
@prepend('scripts')
<script type="module" src="{{Vite::asset('resources/js/dealsock/add.js')}}"></script>
@endprepend
