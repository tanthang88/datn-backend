...
const columns = [
    ...
    },
    {
        ...
        render: function (data) {
            return `
            <input type="number"  value="${data!=null?data:1}" class="tiente mucgiam form-control" id="mucgiam" name="mucgiam" placeholder="% or VND" >
            `;
        },
    },
    {
...
let id_promotion = $("#dealsock_name").data("id_promotion");
dataTable(
    columns,
    url,
    "#dataTableLoadSpSession",
    { edit: id_promotion },
    "GET"
);
//combo
...
const columnscombo = [
    ...
    },
    {
        ...
        render: function (data) {
            return `
            <input type="number" min="1" class="tiente mucgiam form-control" name="mucgiamcombo[]" value="${data!=null?data:1}"  placeholder="% or VND" >
            `;
        },
    },
    {
...
dataTable(
    columnscombo,
    urlCombo,
    "#dataTableLoadSpSessionCombo",
    { editCombo: id_promotion },
    "GET"
);
// end combo session
const columns0 = [
