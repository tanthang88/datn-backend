 ...
 * @version v3.2.0
 * @license MIT
 * @link http://itsjavi.com/bootstrap-colorpicker/
 * @link http://github.com/itsjavi/bootstrap-colorpicker.git
 */
...
cs.get.rgb = function (string) {
	...
	if (match = string.match(hex)) {
		...
		for (i = 0; i < 3; i++) {
			// http://jsperf.com/slice-vs-substr-vs-substring-methods-long-string/19
			var i2 = i * 2;
