...
// http://stackoverflow.com/questions/6024666/getting-ie-to-replace-a-regex-with-the-literal-string-0
...
// http://tc39.es/ecma262/#sec-tointeger
...
// http://tc39.es/ecma262/#sec-arraybuffer-constructor
...
// http://tc39.es/ecma262/#sec-function-instances-name
  ...
  return [
    ...
    function (regexp, replaceValue) {
      ...
      for (var i = 0; i < results.length; i++) {
        ...
        // causes a crash (http://pastebin.com/N21QzeQA) when trying to debug it.
...
// http://tc39.es/ecma262/#sec-%typedarray%.prototype.set
...
// http://tc39.es/ecma262/#sec-%typedarray%.prototype.tostring
...
// http://tc39.es/ecma262/#sec-typedarray-objects
  ...
  _createClass(Emitter, [{
    ...
    value: function makeEvent(eventName, detail) {
      ...
      if (typeof window.CustomEvent === "function") {
        ...
        // IE 11 support
        // http://developer.mozilla.org/en-US/docs/Web/API/CustomEvent/CustomEvent
...
var defaultOptions = {
   ...
   * [`accept`](http://developer.mozilla.org/en-US/docs/HTML/Element/input#attr-accept)
  ...
  /**
   * A function that gets a [file](http://developer.mozilla.org/en-US/docs/DOM/File)
...
var Dropzone = /*#__PURE__*/function (_Emitter) {
  ...
  dropzone_createClass(Dropzone, [{
        ...
        return dirReader.readEntries(function (entries) {
          if (entries.length > 0) {
            ...
            try {
              ...
              // See: http://developer.mozilla.org/en-US/docs/Web/API/DirectoryReader#readEntries
    ...
    value: function createThumbnailFromUrl(file, width, height, resizeMethod, fixOrientation, callback, crossOrigin) {
      ...
      // See http://github.com/enyo/dropzone/pull/226
    ...
    value: function _uploadData(files, dataBlocks) {
      ...
      xhr.open(method, url, true); // Setting the timeout after open because of IE11 issue: http://gitlab.com/meno/dropzone/issues/8

      xhr.timeout = this.resolveOption(this.options.timeout, files); // Has to be after `.open()`. See http://github.com/enyo/dropzone/issues/179
...
//
// http://developer.mozilla.org/en-US/docs/HTML/Element/input#attr-accept
...
// This is a bug in iOS6 devices. This function from http://github.com/stomita/ios-imagefile-megapixel
